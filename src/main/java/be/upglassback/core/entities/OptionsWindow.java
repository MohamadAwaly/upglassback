...
@NamedQueries(value = {
        ...
        @NamedQuery(name = "Option.byId", query = "select o from OptionsWindow  o " +
                "left join WindowOptionWindow wow on wow.optionsWindow = o " +
                "left join Window w on wow.window = w " +
                "where w.idWindow = :id"),
        @NamedQuery(name = "Option.getOptionById", query = "select o from OptionsWindow  o where o.idOptionsWindow = :id")
})
