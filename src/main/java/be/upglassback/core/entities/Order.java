...
@NamedQueries(value = {
        @NamedQuery(name = "Order.list", query = "select o from Order o ORDER BY o.idOrder desc "),
        @NamedQuery(name = "Order.ids", query = "select o.idOrder from Order o")
})
...
public class Order implements Serializable {
    ...
    private User        user;
    @ManyToOne
    @JoinColumn( name = "id_appointment", referencedColumnName = "id_appointment", nullable = true )
